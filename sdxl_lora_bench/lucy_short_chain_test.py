...
GUIDES_DIR = "/Users/christopher/HellCEO/hellcorp/sdxl_lora_bench/out/lucy_quick_test/guides"

OUT_DIR = "/Users/christopher/HellCEO/hellcorp/sdxl_lora_bench/out/lucy_short_chain_test"
...
STRENGTH_PASS2 = 0.35
CANVAS = 1024
KEYFRAME_IDX = [0, 9, 17]   # first half of the cycle only, short test
BG = (43, 35, 32)
...
print(f"{len(frames)} frames in this short test", flush=True)
...
print("SHORT_TEST_DONE", flush=True)
